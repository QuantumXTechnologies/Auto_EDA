...
st.title("Harnessing the Power of AI to Automate Eeploratory Data Analysis Built under <a href='https://quantumxtechnologies.github.io/home/'>QuantumX</a> :bar_chart: :coffee:", unsafe_allow_html=True)
...
st.markdown("Please feel free to connect with us here if you want to learn how to create data analysis for better data in AI systems.", unsafe_allow_html=True)
